...
test("server-renders the FirstFold Studio homepage", async () => {
  ...
  assert.match(html, /Launch with what you need today/);
  ...
  assert.match(html, /Human taste\. AI speed/);
